...
3. Web admin panel default IP is 192.168.3.1 and default password is "password".
...
3. Run `git clone https://github.com/BCYDTZ/lede` to clone the source code, and then `cd lede` to enter the directory
